...
<c:set var="u" value="${usuarioEditar}" />
    ...
    >
      ...
      <form id="registrarForm" action="${modo == 'editar' ? 'editarUsuario' : 'agregar'}" method="post">
	      ...
	      <div class="text-danger m-2" id="errorMsgUser"></div>
	      <div class="col-12 m-1">
	      ...
	      <div class="text-danger m-2" id="errorMsgPass"></div>
	      <div class="col-12 m-1">
	      	<label class="form-label" for="rol">Rol: </label>
	      	<select class="form-select" name="rol" id ="rol">
		      	<option value ="" ${u == null ? 'selected' : ''}>Seleccione un rol</option>
		      	<option value="USER" ${u != null && 'USER'.equals(u.rol) ? 'selected' : ''}>USER</option>
		      	<option value="ADMIN" ${u != null && 'ADMIN'.equals(u.rol) ? 'selected' : ''}>ADMIN</option>
	      	</select>
	      </div>
	      <div class="text-danger m-2" id="errorMsgRol"></div>
